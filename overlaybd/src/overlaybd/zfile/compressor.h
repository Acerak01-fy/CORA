...
public:
    ...
    // FastCDC parameters (not written to file header)
    bool use_fastcdc = false;
    uint32_t fastcdc_min_size = 2048;   // 2KB min chunk
    uint32_t fastcdc_avg_size = 8192;   // 8KB avg chunk
    uint32_t fastcdc_max_size = 65536;  // 64KB max chunk
